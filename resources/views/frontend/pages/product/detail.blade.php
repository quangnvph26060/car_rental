                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    @if ($product->types->count() > 0)
                                                        @foreach ($product->types as $key => $type)
                                                            <a href="https://xecuoiluxury.com/dich-vu/xe-cuoi-dep/" rel="tag">{{ $type->name }}</a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="https://xecuoiluxury.com/dich-vu/xe-cuoi-dep/" rel="tag">{{ $product->brands->first()->name }}</a>
                                                @endif
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="https://xecuoiluxury.com/mau-sac/xe-cuoi-mau-trang/"><span
                                                            class="mona-span-color" style="width: 100%"><span> {{ isset($product->color) ? $product->color->name : ''  }} </span></span></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                    ...
                    <div class="prd-detail__descript">
                        ...
                        <div class="mona-content">
                            <h1 style="text-align: center">
                                <span style="color: #3366ff; font-size: 18pt"><strong>CHO THUÊ XE CƯỚI {{ $product->name }} TẠI HÀ
                                        NỘI</strong></span>
                            </h1>
                            {!! $product->description !!}
