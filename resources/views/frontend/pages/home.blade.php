                ...
                <div class="row100">
                    ...
                    <div class="col75 right">
                                ...
                                <li class="product__item" src-popup=".mona-popup-1417">
                                    <div class="product-block">
                                        ...
                                        <div class="ct">
                                            <p class="hd">
                                                <a
                                                    href="https://xecuoiluxury.com/san-pham/gia-cho-thue-xe-cuoi-mercedes-c200/">{{ $car->name }}</a>
                                            </p>
                        ...
                        <div class="more-button">
                            <a href="https://xecuoiluxury.com/xe-cuoi/" data-max="2" data-page="0"
                ...
                <ul class="list-hnews clear">
                    <li class="news__item">
                        <div class="news-block1">
                            <div class="img">
                                <a href="https://xecuoiluxury.com/vi-sao-ban-nen-chon-xecuoiluxury-com/">
                                    <img width="800" height="723"
                                        src="https://xecuoiluxury.com/wp-content/uploads/2019/01/thue-xe-cuoi-audi-rs5-mui-tran-2.png"
                                        class="attachment-full size-full wp-post-image" alt=""
                                        srcset="
                    https://xecuoiluxury.com/wp-content/uploads/2019/01/thue-xe-cuoi-audi-rs5-mui-tran-2.png         800w,
                    https://xecuoiluxury.com/wp-content/uploads/2019/01/thue-xe-cuoi-audi-rs5-mui-tran-2-300x271.png 300w,
                    https://xecuoiluxury.com/wp-content/uploads/2019/01/thue-xe-cuoi-audi-rs5-mui-tran-2-768x694.png 768w
                  "
                            ...
                            <div class="ct">
                                <p class="hd">
                                    <a href="https://xecuoiluxury.com/vi-sao-ban-nen-chon-xecuoiluxury-com/">Vì Sao
                                        Bạn Nên Chọn XeCuoiLuxury.com</a>
                                </p>
                                <p class="date">Đăng ngày 21 Tháng Chín, 2019</p>
                                <div class="mona-except">
                                    <p>
                                        5 LÝ DO BẠN NÊN ĐẶT THUÊ XE TẠI XECUOILUXURY.COM
                                        [&hellip;]
                                    </p>
                                </div>
                ...
                <ul class="list-ctbrand clear">
                    <li class="brand__item">
                        <div class="contact-block">
                            ...
                            <p>Tầng 4 &#8211; Viet Tower &#8211; Số 01 Thái Hà</p>
                    ...
                    <li class="brand__item">
                        <div class="contact-block">
                            ...
                            <p>Chủ Nhật: Liên Hệ: 094.8888.438</p>
                            <p>&nbsp;</p>
                        </div>
                    </li>
                    <li class="brand__item">
