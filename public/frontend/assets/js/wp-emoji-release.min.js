...
var twemoji = (function () {
            ...
            : function (d, u) {
                ...
                for (; p--; ) {
                  for (
                    ...
                    if (
                      ((s = i.index) !== r &&
                        a.appendChild(g(n.slice(r, s), !0)),
                      (o = i[0]),
                      (i = x(o)),
                      (r = s + o.length),
                      (s = u.callback(i, u)))
                    ) {
                      for (e in (((b = new Image()).onerror = u.onerror),
                  ...
                  c &&
                    (r < n.length && a.appendChild(g(n.slice(r), !0)),
  ...
  function i(d, u) {
    for (var f = [], e = 0, c = 0, a = 0; a < d.length; )
      (e = d.charCodeAt(a++)),
        c
          ? (f.push((65536 + ((c - 55296) << 10) + (e - 56320)).toString(16)),
            (c = 0))
          : 55296 <= e && e <= 56319
          ? (c = e)
